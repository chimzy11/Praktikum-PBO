    ...
    public void biografiLksKlasikisme() throws IOException{
        ...
        if (clsKlasikisme.size() != 0){
            ...
            for (int i = 0; i < clsKlasikisme.size(); i++){
                ...
                System.out.println("Id Lukisan        : LK" +  clsKlasikisme.get(i).getIdKlasikisme());
                System.out.println("Judul Lukisan     : " +  clsKlasikisme.get(i).getJudul());
                System.out.println("Nama Pelukis      : " +  clsKlasikisme.get(i).getNamaPelukis());
                System.out.println("Ukuran Lukisan    : " +  clsKlasikisme.get(i).getPanjang() + " cm" + " x " + clsKlasikisme.get(i).getLebar() + " cm");
                System.out.println("Berat Lukisan     : " +  clsKlasikisme.get(i).getBerat() + " Kg");
                System.out.println("Tahun Pembuatan   : " +  clsKlasikisme.get(i).getTahunPembuatan());
                System.out.println("Harga Lukisan     : " +  clsKlasikisme.get(i).getHarga());
                System.out.println("");
