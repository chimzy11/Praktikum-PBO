...
public class Manage_Optik {
    ...
    public void createLksOptik() throws IOException{
        ...
        Lukisan_Optik NewLukisan = new Lukisan_Optik(Judul, NamaPelukis, Panjang, Lebar, TahunPembuatan, Harga, Berat, IdOptik);
    ...
    public void biografiLksOptik() throws IOException{
        ...
        if (clsOptik.size() != 0){
            ...
            for (int i = 0; i < clsOptik.size(); i++){
                ...
                System.out.println("Id Lukisan        : LOP" +  clsOptik.get(i).getIdOptik());
                System.out.println("Judul Lukisan     : " +  clsOptik.get(i).getJudul());
                System.out.println("Nama Pelukis      : " +  clsOptik.get(i).getNamaPelukis());
                System.out.println("Ukuran Lukisan    : " +  clsOptik.get(i).getPanjang() + " cm" + " x " + clsOptik.get(i).getLebar() + " cm");
                System.out.println("Berat Lukisan     : " +  clsOptik.get(i).getBerat() + " Kg");
                System.out.println("Tahun Pembuatan   : " +  clsOptik.get(i).getTahunPembuatan());
                System.out.println("Harga Lukisan     : " +  clsOptik.get(i).getHarga());
                System.out.println("");
        ...
        if (clsOptik.size() > 0){
            ...
            if (idx > 0 ){
                if (idx <= clsOptik.size() && idx > 0){
                    ...
                    Lukisan_Optik updateLukisan = new Lukisan_Optik (Judul, NamaPelukis, Panjang, Lebar, TahunPembuatan, Harga, Berat, IdOptik);
