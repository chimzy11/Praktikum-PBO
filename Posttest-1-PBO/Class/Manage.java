    ...
    public static void katalogLks() throws IOException{
        ...
        if (clsLukisan.size() != 0){
            for (int i = 0; i < clsLukisan.size(); i++){
                int j = i + 1;
                System.out.println((char)27 +  "[01;35m [" + j + "]" + " " +  clsLukisan.get(i).Judul + "\n    ldr " + clsLukisan.get(i).Harga + (char)27 + "[00;00m");
                System.out.println("");
            }
        }
        else {
    ...
    public static void biografiLks() throws IOException{
        ...
        if (clsLukisan.size() != 0){
            ...
            for (int i = 0; i < clsLukisan.size(); i++){
                ...
                System.out.println("Judul Lukisan     : " +  clsLukisan.get(i).Judul);
                System.out.println("Nama Pelukis      : " +  clsLukisan.get(i).NamaPelukis);
                System.out.println("Jenis Lukisan     : " +  clsLukisan.get(i).JenisLukisan);
                System.out.println("Ukuran Lukisan    : " +  clsLukisan.get(i).Panjang + " cm" + " x " + clsLukisan.get(i).Lebar + " cm");
                System.out.println("Tahun Pembuatan   : " +  clsLukisan.get(i).TahunPembuatan);
                System.out.println("Harga Lukisan     : " +  clsLukisan.get(i).Harga);
                System.out.println("");
