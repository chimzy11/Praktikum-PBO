...
import Interface.Interface_Manage_Klasikisme;
...
public final class Manage_Klasikisme implements Interface_Manage_Klasikisme{
    ...
    public void createLksKlasikisme() throws IOException{
        ...
        Lukisan_Klasikisme NewLukisan = new Lukisan_Klasikisme(Judul, NamaPelukis, Panjang, Lebar, TahunPembuatan, Harga, Berat, IdKlasikisme, null);
        ...
        if (clsKlasikisme.size() > 0){
            ...
            if (idx > 0 ){
                if (idx <= clsKlasikisme.size() && idx > 0){
                    ...
                    Lukisan_Klasikisme updateLukisan = new Lukisan_Klasikisme (Judul, NamaPelukis, Panjang, Lebar, TahunPembuatan, Harga, Berat, IdKlasikisme, null);
