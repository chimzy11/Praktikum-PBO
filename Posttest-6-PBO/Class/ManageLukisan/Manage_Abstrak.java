...
import Interface.Interface_Manage_Abstrak;
...
public final class Manage_Abstrak implements Interface_Manage_Abstrak{
    ...
    public void createLksAbstrak() throws IOException{
        ...
        while (crt == true){
            ...
            if(chsTeknik == 1){
                ...
                Lukisan_Abstrak NewLukisanPlakat = new Lukisan_Abstrak (Judul, NamaPelukis, Panjang, Lebar, TahunPembuatan, Harga, Berat, IdAbstrak, TeknikPembuatan, null);
                ...
                Lukisan_Abstrak NewLukisanTransparan = new Lukisan_Abstrak (Judul, NamaPelukis, Panjang, Lebar, TahunPembuatan, Harga, Berat, IdAbstrak, TeknikPembuatan, null);
                ...
                if (TeknikPlakat.size() > 0){
                    ...
                    if (idx > 0 ){
                        if (idx <= TeknikPlakat.size() && idx > 0){
                            ...
                            String TeknikPembuatan = "Teknik Plakat";
                            Lukisan_Abstrak updateLukisan = new Lukisan_Abstrak (Judul, NamaPelukis, Panjang, Lebar, TahunPembuatan, Harga, Berat, IdAbstrak, TeknikPembuatan, null);
